...
def model_opts(parser):
    ...
    parser.add_argument('-asp_fusion_mode', type=str, default='attn_multi',
                        choices=['attn_multi', 'cat_single', 'cat_multi', 'attn_single'],
                        help='aspect fuse method.')

    parser.add_argument('-sentiment_gen', default=False,
                        action="store_true",
                        help="whether use sentiment for generation")

    parser.add_argument('-sentiment_loss', default=False,
                        action="store_true",
                        help="whether use sentiment for update")

    parser.add_argument('-snippet_copy', default=False,
                        action="store_true",
                        help="whether use the snippet for copy")

    parser.add_argument('-snippet_loss', default=False,
                        action="store_true",
                        help="whether use the snippet for update")

    parser.add_argument('-include_peos', default=False,
                        action="store_true",
                        help="whether include the peos in target")
...
def vocab_opts(parser):
    # Dictionary Options
    parser.add_argument('-vocab_size', type=int, default=4600,
...
def train_opts(parser):
    ...
    parser.add_argument('-vocab', default='./data/',  # required=True,
