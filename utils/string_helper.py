...
def prediction_to_sentence(prediction, idx2word, eos_idx):
    """
...
def split_word_list_by_delimiter(word_list, keyphrase_delimiter, include_present_absent_delimiter=False,
                                 present_absent_delimiter=None):
    """
